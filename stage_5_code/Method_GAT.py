...
class GAT(torch.nn.Module):
    ...
    def __init__(self, num_of_layers, num_heads_per_layer, num_features_per_layer, add_skip_connection=True, bias=True,
        ...
        super().__init__()
        print(num_of_layers)
        print(len(num_heads_per_layer))
        print(len(num_features_per_layer))
    ...
    def run(self, *argv):
        ...
        self.adj = argv[1]
        self.adj = adjacency_matrix_to_edge_pairs(self.adj)
        ...
        return
def adjacency_matrix_to_edge_pairs(adj_matrix):
    edge_pairs = []
    ...
    # non_zero_indices = np.argwhere(adj_matrix)
    # edge_pairs = non_zero_indices.T  # Transpose to get (2, E) shape
    return edge_pairs